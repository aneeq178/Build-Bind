      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                Consumer<PFilterProvider>(builder: (context, data, child) {
                  return
                    Container(
                      padding: EdgeInsets.all(2.w),
                      decoration: BoxDecoration(
                      ...
                      child:  Row(
                        children: [
                          ...
                          GestureDetector(
                              onTap: () {
                                searchctrl.searchProjects(
                                    'name', _searchcontroler.text,
                                    'estimated_cost', data.fillter_p_cost==0?'':
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      var ctrl= context.read<PFilterProvider>();
                      ctrl.resetFilters();
                    },
                    child: Container(
                      padding: EdgeInsets.all(2.w),
              ...
              Align(
                ...
                child: GestureDetector(
                  onTap: (){
                    ...
                    searchctrl.searchProjects(
                        'name', '',
                        'estimated_cost', data.fillter_p_cost==1?'10000':
                    data.fillter_p_cost==2?'20000'
                        :'20000',

                        'category', data.fillter_p_categroy==1?'residential':'commercial',
