...
class _ProjectDetaillsState extends State<ProjectDetaills> {
  @override
  void initState() {
    imageUrls.add('$BASEURL/${widget.project.image1}');
    imageUrls.add('$BASEURL/${widget.project.image2}');
    imageUrls.add('$BASEURL/${widget.project.image3}');
    super.initState();
  }
                  ...
                  widget.from=='C'?GestureDetector(
                    ...
                    child: Container(
                      ...
                      Column(children: [
                        GestureDetector(
                          onTap: (){
                            ...
                            ctrl.approveProjectC(widget.project.pId.toString(), context);
                          },
                          child: Container(
                            width:60.w,
                            height: 8.h,
                            ...
                            child: Center(
                              child: Text('Mark as Complete', style: TextStyle(color: APPCOLORS.WHITE,
                                  fontSize: 12.sp,
                                  fontWeight: FontWeight.bold),),
                            ),
                          ),
                        ...
                        GestureDetector(
                          onTap: (){
                            context.navigateTo(RatingView(pId:widget.project.pId.toString(),cId:widget.project.pAssgnCid.toString(),));
                          },
                          child: Container(
                            width:60.w,
                            height: 8.h,
                            ...
                            child: Center(
                              child: Text('Rate Contractor', style: TextStyle(color: APPCOLORS.WHITE,
                                  fontSize: 12.sp,
                                  fontWeight: FontWeight.bold),),
                            ),
                          ),
                     ...
                     :
                          ...
                          onTap: (){
                            var ctrl=ProjectController();
                            ctrl.completeProjectC(widget.project.pId.toString(), context);
                          },
                          child: Container(
                          width:60.w,
                          height: 8.h,
